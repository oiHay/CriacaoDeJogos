...
public class UIManager : MonoBehaviour
{
    ...
    {
        if (settingsPanel == null || choosingPowerUp == null || gameOverPanel == null || victoryPanel == null) 
            return; // Proteção contra referências destruídas, evita o erro MissingReferenceException
